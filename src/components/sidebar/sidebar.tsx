...
const Sidebar = ({
    ...
    return (
        <div style={styles.container}>
            ...
            />
            {isParksDropdownOpen&&<div style={{color:"var(--text-disabled)", paddingLeft:"10px", fontSize:"15px"}}>what are you looking for? :D</div>}
            <ToggleButton
                text="Heatmap"
            ...
            />
            {isHeatmapDropdownOpen&&<div style={{color:"var(--text-disabled)", paddingLeft:"10px", fontSize:"15px"}}>nothing's here, come back later</div>}
