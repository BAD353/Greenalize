...
export default function LandingPage() {
  ...
  function filter(custom_query?: string | undefined) {
    ...
    const matches = cities
      .filter((c) => (c.city.toLowerCase() + c.country.toLowerCase()).replace(/ /g, "").includes(q))
      .slice(0, 1000);
    setFiltered(matches);
      ...
      <div style={styles.container}>
        ...
        <div style={styles.searchContainer} ref={searchContainerRef}>
          <input
            ...
            onMouseOver={(e) => {
              e.currentTarget.style.boxShadow = "0 8px 30px rgba(121, 163, 124, 0.35)";
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.boxShadow = "0 8px 30px rgba(121, 163, 124, 0.15)";
            }}
          />
          {showDropdown && (
